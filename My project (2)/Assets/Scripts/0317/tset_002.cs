...
public class tset_002 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        answer = 1 + 2;                     //answer에 1 + 2연산 값을 입력
        ...
        string message = str + answer3;     //문자열 massage를 선언하고 (String)값 str과 (int)값 answer를 더한다
        Debug.Log(message);                 //massage 값을 Debug.Log에 출력 시킨다
