...
public class PlayerController : MonoBehaviour
{
    ...
    Camera viewCamera;                                      //카메라 전보 값을 가져오기 위해 선언
    ...
    void Update()
    {
        ...
        //바라볼 위치를 계산하기 위해서오브젝트 y축 좌표를 설정 (바닥은 x,z 축)
    ...
    private void FixedUpdate()
    {
        ...
        //GetComponet -> 소스가 있는 게임 오브젝트에서 <> 안에 있는 컴포넌트를 접근
        //접근 한 후에 계산 된 이동 위치 값을 MovePoisition
    }
}
